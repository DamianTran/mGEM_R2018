...
# Sample:
reads = simNGSmatrix(100,100,randSeq(20),0.1,0.9)
...
if(p_value <= 0.05){
  cat("The sequence ", freq$uniqueSeq[1], " is signiicantly enriched in the population\n")
}else{
  cat("The sequence ", freq$uniqueSeq[1], " is not signiicantly enriched in the population\n")
}
cat("Dataset avg: ", avg, "\nDataset SD: ", st_dev,
    "\nCount: ", mutCount, "\nTest score: ", z_score, 
    "\nP value: ", p_value, '\n\n')
